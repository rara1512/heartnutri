...
<nav class="navbar fixed-top" style = "box-shadow: 0 .5rem 1.5rem rgba(0, 0, 0, .1); background-color: white;" >
  ...
  <a href="https://heartify-ui.s3.amazonaws.com/index.html" class="logo" style="font-family: 'Poppins', sans-serif; font-size: 162.5%; color: black; text-decoration: none; color: #3c3c3c;"> <i class="fas fa-heartbeat" style = "color: #16a085;"></i> Heartify.</a>
  </div>
</nav>
""", unsafe_allow_html=True)
